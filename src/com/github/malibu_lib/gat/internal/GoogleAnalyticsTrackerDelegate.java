 ...
 * GoogleAnalyticsTracker. GoogleAnalyticsTracker is a singleton with a private
 * constructor, so cannot be extended. Note that this delegate will only expose
 * those public methods of GoogleAnalyticsTracker that are used by EasyTracker.
 */
