...
public interface ParameterLoader {
	...
	/**
	 * Look up the boolean value represented by the string resource whose name is key.
	 * 
	 * @param key
	 *            the key for the string resource we're seeking
	...
	/**
	 * Look up the integer value represented by the string resource whose name is key.
	 * 
	 * @param key
	 *            the key for the string resource we're seeking
	 * @param defaultValue
	 *            the value to return if the key isn't found
	 * @return the int value found, or the defaultValue if the key wasn't found or couldn't be
	 *         parsed into an int.
	 */
